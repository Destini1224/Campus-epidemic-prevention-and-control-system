    ...
    <div class="container">
      <div class="brand">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>物资审批</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <div>
        <div class="aside">
        ...
        <el-main class="main">
          ...
          <el-table :data="tableData" border stripe style="width: 97%;margin:20px 0 20px 20px;">
            ...
            <el-table-column prop="goods_name" label="物资名称" width="105">
            </el-table-column>
            <el-table-column prop="application" label="申请量(份)" width="105">
            </el-table-column>
          ...
          <!-- 新增弹窗区域 -->
          <el-dialog title="物资申请审批" :visible.sync="dialogFormVisible" width="30%" top="6vh" center>
            <el-form :model="addForm" :rules="rules" ref="addForm" label-width="80px" size="medium">
              ...
              <el-form-item label="申请量(份)" prop="application">
              ...
              <el-form-item label="审批状态" prop="status">
                <el-select v-model="addForm.status" placeholder="请输入审批状态">
...
export default {
  ...
  methods: {
    ...
    //   this.addForm = { username: '', name: '', plan_go: '', plan_reach: '', becity: '', emergency_tel: '', evidences: '', remarks: '', status: '' }
    // },
    // 获得某条信息
    getInfo() {
      request.get('/application/' + this.id).then(res => {
        this.$nextTick(() => {
          this.addForm = { ...res[0] }
        })
      })
