        ...
        <el-main class="main">
          ...
          <el-table :data="tableData" border stripe style="width: 97%;margin:20px 0 20px 20px;">
            ...
            <el-table-column fixed="right" label="操作" width="180">
              <template slot-scope="scope">
                <!-- <el-button type="warning" @click="handleEdit(scope.row)" :disabled="scope.row.status === '0' ? false : true">编辑<i style="margin-left:2px;" class="el-icon-edit"></i></el-button> -->
          ...
          <!-- 新增弹窗区域 -->
          <el-dialog title="离校申请" :visible.sync="dialogFormVisible" width="32%" top="6vh" center>
            <el-form :model="addForm" :rules="rules" ref="addForm" label-width="120px" size="medium">
              ...
              <el-form-item label="计划离校时间" prop="plan_leave">
                <el-date-picker type="datetime" format="yyyy 年 MM 月 dd 日 HH时mm分ss秒" value-format="yyyy-MM-dd HH:mm:ss" placeholder="请选择计划离校时间" v-model="addForm.plan_leave" style="width: 100%;"></el-date-picker>
              </el-form-item>
              ...
              <el-form-item label="目的地" prop="destination">
                <el-input type="text" :rows="2" auto-complete="false" v-model="addForm.destination" placeholder="请输入目的地">
                </el-input>
              </el-form-item>
              ...
              <el-form-item label="计划返校时间" prop="plan_back">
                <el-date-picker type="datetime" format="yyyy 年 MM 月 dd 日 HH时mm分ss秒" value-format="yyyy-MM-dd HH:mm:ss" placeholder="请选择计划返校时间" v-model="addForm.plan_back" style="width: 100%;"></el-date-picker>
              </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        plan_leave: [{ required: true, message: '请选择计划离校时间', trigger: 'change' }],
        ...
        plan_back: [{ required: true, message: '请选择计划返校时间', trigger: 'change' }]
      }
    }
  },
  created() {
  ...
  methods: {
    ...
    handleAdd() {
      ...
      this.addForm = { username: this.username, name: '', plan_leave: '', plan_reach: '', destination: '', emergency_tel: '', plan_back: '', evidences: '', remarks: '' }
    },
    // // 编辑
    // handleEdit(id) {
    //   request.post('/departure/' + id).then(res => {
    //     if (res) {
